...
<div class="banner">
    ...
    <div class="portal" id="portal">
        <ul>
            <li>
                <a href="style_two.html">
                    <div><img src="{{asset('images/tup1.png')}}" alt=""></div>
                    <p>两厅文化</p>
                </a>
            </li>
            <li>
                <a href="style_three.html">
            ...
            <li>
                <a href="style_four.html">
                    <div><img src="{{asset('images/tup4.png')}}images/tup4.png" alt=""></div>
                    <p>家居动漫</p>
                </a>

            </li>
            <li>
                <a href="style_five.html">
    ...
    <div class="video" id="video">
        <ul>
            <li><div><img src="images/whiteLogo.jpg" alt=""></div></li>
            <li>
                <div>
                    <video id="my-video" class="video-js container" poster="images/mp4.png" data-setup="{}" controls="controls">
                        <source src="video.mp4" type="video/mp4" autostart="false" loop="false">
                    </video>
                </div>
            </li>
    ...
    <div class="contact" id="contact">
        ...
        <div class="clearfix">
            <!--form-->
            <div>
                <div><div class="btn1">加盟</div><div class="btn2">应聘</div></div>
                <form class="form1" action="">
                    <div class="input-group">
                        <span class="input-group-addon">姓名</span>
                        <input id="name" type="text" class="form-control" placeholder="请输入姓名" aria-describedby="basic-addon1">
                    </div>
                    <div class="input-group">
                    ...
                    <div class="input-group">
                        ...
                        <input id="age" type="text" class="form-control" placeholder="请输入年龄" aria-describedby="basic-addon1">
                    </div>
                    <div class="input-group">
                    ...
                    <div  class="input-group work">
                        ...
                        <label class="checkbox-inline pmsj">
                            <input type="checkbox" value="option1" >平面设计
                        </label>
                        <label class="checkbox-inline">
                            <input type="checkbox" value="option2">卧室设计
                        </label>
                        <label class="checkbox-inline">
                            <input type="checkbox" value="option3">儿童设计
                        </label>
                        <label class="checkbox-inline">
                            <input type="checkbox" value="option3">客厅文化设计
                        </label>
                        <label class="checkbox-inline">
                            <input type="checkbox" value="option3">空间设计
                        </label>
                        <label class="checkbox-inline">
                            <input type="checkbox" value="option3">动漫设计
                        </label>
                    </div>
                    <div  class="input-group">
                        ...
                        <label class="checkbox-inline">
                            <input type="checkbox" value="option2">读书
                        </label>
                        <label class="checkbox-inline">
                            <input type="checkbox" value="option3">旅游
                        </label>
                        <label class="checkbox-inline">
                            <input type="checkbox" value="option3">健身
                        </label>
                    </div>
                    <div class="verification">
                        <input id="yzm" value="" type="text" class="form-control" placeholder="请输入验证码" aria-describedby="basic-addon1">
                ...
                <form class="form2" action="">
                    <div class="input-group">
                        <span class="input-group-addon">姓名</span>
                        <input id="name2" type="text" class="form-control" placeholder="请输入姓名" aria-describedby="basic-addon1">
                    </div>
                    <div class="input-group">
                        <span class="input-group-addon">性别</span>
                        <label class="checkbox-inline">
                    ...
                    <div class="input-group">
                        ...
                        <input id="school" type="text" class="form-control" placeholder="请输入毕业学院" aria-describedby="basic-addon1">
                    </div>
                    <div class="input-group">
                        <span class="input-group-addon">专业</span>
                        <input id="major" type="text" class="form-control" placeholder="请输入专业" aria-describedby="basic-addon1">
                    </div>
                    <div class="input-group">
                        <span class="input-group-addon">年龄</span>
                        <input id="age2" type="text" class="form-control" placeholder="请输入年龄" aria-describedby="basic-addon1">
                    </div>
                    <div class="input-group">
                        <span class="input-group-addon">联系方式</span>
                        <input id="tel2" type="text" class="form-control" placeholder="请输入联系方式" aria-describedby="basic-addon1">
                    </div>
                    <div  class="input-group">
                        <span class="input-group-addon">兴趣爱好</span>
                        <label class="checkbox-inline pmsj">
                    ...
                    <div class="verification">
                        <input id="yzm2" value="" type="text" class="form-control" placeholder="请输入验证码" aria-describedby="basic-addon1">
            ...
            <div class="map">
                ...
                <p><a href="http://ditu.amap.com/dir?from%5Bname%5D=%E6%88%91%E7%9A%84%E4%BD%8D%E7%BD%AE&from%5Bid%5D=dirmyloc&from%5Badcode%5D=510100&from%5Bpoitype%5D=&from%5Blnglat%5D=104.03234%2C30.71208&from%5Bmodxy%5D=104.03234%2C30.71208&to%5Bname%5D=%E5%AF%8C%E9%A1%BF%E4%B8%AD%E5%BF%83B%E5%BA%A7&to%5Blnglat%5D=103.985754%2C30.604066&to%5Bid%5D=B0FFGB5BNJ&to%5Bpoitype%5D=120201&to%5Badcode%5D=510100&to%5Bmodxy%5D=103.985754%2C30.604066&type=car&policy=1" target="_blank" role="button">到公司来</a></p>
            </div>
        </div>
    </div>
    <!--footer-->
...
<script type="text/javascript">//加盟验证脚本
    ...
    function validate(){
    	...
    	if (flag1&&flag2&&flag3&&flag4&&flag5 ) {
    		window.open("htts://www.65jjj.com");//提交地址
...
<script type="text/javascript">//应聘验证脚本
    ...
    function validates(){
    	if (a&&b&&c&&d&&e) {
    		window.open("htts://baidu.65jjj.com");//提交地址
