...
<div class="logo_box">
    ...
    <div class="input_outer">
        ...
        <input name="logname" class="text" id="text" onFocus=" if(this.value=='输入管理账号') this.value=''"
               onBlur="if(this.value=='') this.value='输入管理账号'" value="输入管理账号" style="color: #FFFFFF !important"
               type="text">
    </div>
    <div class="input_outer">
        <span class="us_uer"></span>
        <input name="logpass" class="text" id="password"
               style="color: #FFFFFF !important; position:absolute; z-index:100;" onFocus="$('.login_password').hide()"
               onBlur="if(this.value=='') $('.login_password').show()" value="" type="password"/>
    </div>
