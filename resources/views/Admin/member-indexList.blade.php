		...
		<table class="table table-border table-bordered table-hover table-bg table-sort">
			...
			@foreach($list as $v)
				<tr class="text-c">
					...
					<td>{{$v->join_id}}</td>
					<td><u style="cursor:pointer" class="text-primary" onclick="member_show('张三','member-show.html','10001','360','400')">{{$v->join_name}}</u></td>
					<td>{{$v->join_sex}}</td>
					<td>{{$v->join_school}}</td>
					<td >{{$v->join_major}}</td>
					<td class="text-l" style="text-align: center">{{$v->join_age}}</td>
					...
					<td class="td-manage">
						@if($v->join_see==10)
							<a style="text-decoration:none" onClick="member_stop(this,'{{$v->join_id}}')" href="javascript:;" title="已查看"><i class="Hui-iconfont">&#xe631;</i></a>
						@else
							<a style="text-decoration:none" onClick="member_start(this,'{{$v->join_id}}')" href="javascript:;" title="待查看"><i class="Hui-iconfont">&#xe6e1;</i></a>
						@endif
						<a title="删除" href="javascript:;" onclick="member_del(this,'{{$v->join_id}}')" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6e2;</i></a>
					</td>
				</tr>
			@endforeach
