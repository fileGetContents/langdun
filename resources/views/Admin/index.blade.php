...
<body>
<header class="Hui-header cl"><a class="Hui-logo l" href="/">HI.{{session("admin")['admin_name']}}</a> <a
            class="Hui-logo-m l" href="/">{{session("admin")['admin_name']}}</a> <span
        ...
        <ul>
            <li class="dropDown dropDown_click"><a href="javascript:;" class="dropDown_A"><i class="Hui-iconfont">
                ...
                <ul class="dropDown-menu radius box-shadow">
                    <li><a href="javascript:;" onclick="article_add('添加资讯','article-add')">
                            <i class="Hui-iconfont"></i> 资讯</a></li>
                    <li><a href="javascript:;" onclick="picture_add('添加资讯','picture-add')">
                            <i class="Hui-iconfont">&#xe613;</i> 图片</a></li>
                    <li><a href="javascript:;" onclick="product_add('添加资讯','product-add')">
                            <i class="Hui-iconfont">&#xe620;</i> 产品</a></li>
                    <li><a href="javascript:;" onclick="member_add('添加用户','member-add','','510')">
    ...
    <ul class="Hui-userbar">
        ...
        <li id="Hui-msg"><a href="#" title="消息"><span class="badge badge-danger">1</span><i class="Hui-iconfont"
                    ...
                    &#xe68a;</i></a></li>
        {{--<li id="Hui-skin" class="dropDown right dropDown_hover"><a href="javascript:;" title="换肤">--}}
...
<aside class="Hui-aside">
    ...
    <div class="menu_dropdown bk_2">
        <dl id="menu-article">
            ...
            <dd>
                <ul>
                    <li><a _href="{{URL('article-list')}}" href="javascript:void(0)">资讯管理</a></li>
                </ul>
            </dd>
        </dl>
        <dl id="menu-picture">
            ...
            <dd>
                <ul>
                    <li><a _href="{{ URL('picture-list')  }}" href="javascript:void(0)">图片管理</a></li>
                </ul>
            </dd>
        </dl>
        <dl id="menu-product">
            ...
            <dd>
                <ul>
                    <li><a _href="{{URL('product-brand')}}" href="javascript:void(0)">品牌管理</a></li>
                    <li><a _href="{{URL('product-category')}}" href="javascript:void(0)">分类管理</a></li>
                    <li><a _href="{{URL('product-list')}}" href="javascript:void(0)">产品管理</a></li>
                </ul>
            </dd>
        </dl>
        <!--<dl id="menu-page">
        ...
        <dl id="menu-order">
            ...
            <dd>
                <ul>
                    <li><a _href="{{URL('order-list')}}" href="javascript:void(0)">订单列表</a></li>
                    <li><a _href="{{URL('recharge-list')}}" href="javascript:void(0)">充值管理</a></li>
                    <li><a _href="{{URL('invoice-list')}}" href="javascript:void(0)">发票管理</a></li>
                </ul>
            </dd>
        </dl>
        <dl id="menu-member">
        ...
        <dl id="menu-tongji">
            ...
            <dd>
                <ul>
                    <li><a _href="{{URL('')}}charts-1.html" href="javascript:void(0)">折线图</a></li>
                    <li><a _href="{{URL('')}}charts-2.html" href="javascript:void(0)">时间轴折线图</a></li>
                    <li><a _href="{{URL('')}}charts-3.html" href="javascript:void(0)">区域图</a></li>
                    <li><a _href="{{URL('')}}charts-4.html" href="javascript:void(0)">柱状图</a></li>
                    <li><a _href="{{URL('')}}charts-5.html" href="javascript:void(0)">饼状图</a></li>
                    <li><a _href="{{URL('')}}charts-6.html" href="javascript:void(0)">3D柱状图</a></li>
                    <li><a _href="{{URL('')}}charts-7.html" href="javascript:void(0)">3D饼状图</a></li>
                </ul>
            </dd>
        </dl>
        <dl id="menu-system">
            ...
            <dd>
                <ul>
                    <li><a _href="{{URL('system-base')}}" href="javascript:void(0)">系统设置</a></li>
                    <li><a _href="{{URL('system-category')}}" href="javascript:void(0)">栏目管理</a></li>
                    <li><a _href="{{URL('system-data')}}" href="javascript:void(0)">数据字典</a></li>
                    <li><a _href="{{URL('system-shielding')}}" href="javascript:void(0)">屏蔽词</a></li>
                    <li><a _href="{{URL('system-log')}}" href="javascript:void(0)">系统日志</a></li>
                </ul>
            </dd>
        </dl>
    </div>
