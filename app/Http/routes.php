...
Route::group(['namespace' => "Web"] , function () {
    ...
    Route::any("join" , "AboutController@joinUs");
...
Route::group(['namespace' => "Admin"] , function () {
    ...
    Route::get('joinLists' , 'MemberController@joinLists');
    Route::get('indexLists' , 'MemberController@indexLists');
...
Route::group(['namespace' => "Api"] , function () {
    ...
    // 文件下载
    Route::any('download/file' , 'ApiController@downloadFile');
    // 通用修改文件
    Route::post('uploadTag' , "ApiController@uploadTag");
});
